...
export default function crearCuenta({ navigation }) {
        ...
        if(values.email && values.password){
            ...
            .then((userCredential)=>{
                ...
                .updateProfile({
                    ...
                    ? values.imageUrl : 'https://e7.pngegg.com/pngimages/304/305/png-clipart-man-with-formal-suit-illustration-web-development-computer-icons-avatar-business-user-profile-child-face.png'
                }).then(()=>{
    ...
    return (
            ...
            <View style={{ alignItems: 'center', marginTop: 20, }}>
                ...
                />
                <TextInput placeholder="fds" style={{backgroundColor: 'black'}}></TextInput>
            </View>
